...
Route::middleware(['auth', 'globalgame', 'locale', 'admin'])->group(function () {
    ...
    Route::post('/admin/developershortcuts/spawn-loot-planet', [DeveloperShortcutsController::class, 'spawnLootPlanet'])->name('admin.developershortcuts.spawn-loot-planet');
});
